...
void main() {
  ...
  runApp(
    ...
    ChangeNotifierProvider(
      // 'ThemeProvider'를 새로 만들어서 준비해요.
      create: (context) => ThemeProvider(),
      // 'MyApp'이라는 앱의 가장 큰 부분을 'ThemeProvider'와 함께 실행해요.
      child: const MyApp(),
    ),
  );
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // 'ThemeProvider'의 정보를 지켜보고 있다가, 정보가 바뀌면 앱의 테마를 바꿔줘요.
    return Consumer<ThemeProvider>(
      // 'themeProvider'라는 이름으로 테마 정보를 받아와서 앱을 만들어요.
...
class _InputScreenState extends State<InputScreen> {
  ...
  void _calculate() {
    ...
    if (_nameController.text.isNotEmpty && _selectedDate != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter your name and birth date.'), // 알림 메시지 내용이에요.
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
      ...
      bodyContent = Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Back'), // 버튼에 'Back'이라고 써요.
          ),
        ],
      );
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Name', // 칸 위에 'Name'이라고 써줘요.
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: const Text('Choose Date'), // 버튼에 'Choose Date'라고 써요.
                ),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: const Text('Calculate'), // 버튼에 'Calculate'라고 써요.
                ),
                // 'Reset' 버튼을 만들어요.
                ElevatedButton(
                  onPressed: _clearInput, // 버튼을 누르면 입력 내용을 지우는 함수를 실행해요.
                  child: const Text('Reset'), // 버튼에 'Reset'이라고 써요.
    ...
    return CustomAppScreen(
      title: 'Numerology Finder', // 앱의 제목을 'Numerology Finder'라고 정해요.
      icon: Icons.calculate, // 앱 제목 옆에 계산기 아이콘을 보여줘요.
